package com.senon.zxingdemo.zxing.activity;
...
import com.senon.zxingdemo.R;
import com.senon.zxingdemo.zxing.camera.CameraManager;
import com.senon.zxingdemo.zxing.decoding.CaptureActivityHandler;
import com.senon.zxingdemo.zxing.decoding.InactivityTimer;
import com.senon.zxingdemo.zxing.decoding.RGBLuminanceSource;
import com.senon.zxingdemo.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        back = (TextView) findViewById(R.id.scanner_toolbar_back);
        ...
        findViewById(R.id.scanner_toolbar_album).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //打开手机中的相册
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if (isFlashOn) {
                    // 关闭闪光灯
                    btnFlash.setText("闪光灯已关");
                    isFlashOn = false;
                } else {
                    // 开启闪光灯
                    btnFlash.setText("闪光灯已开");
                    isFlashOn = true;
                }
            }catch (Exception e){
                e.printStackTrace();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result != null) {
                                ...
                                mProgress.dismiss();
                                Toast.makeText(CaptureActivity.this, "二维码识别失败", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    break;
